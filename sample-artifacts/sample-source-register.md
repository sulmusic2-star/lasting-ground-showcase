...
|---|---|---|---|---|
| sample_state_gis | regional context | public GIS | broad screening context | parcel-specific legal conclusion |
| sample_town_zoning | local context | official town source | local reference/routing context | permit approval prediction |
